...
module.exports = "<ion-split-pane>\n  <ion-menu menuId=\"categoryMenu\" side=\"start\" type=\"overlay\">\n    <ion-header>\n      <ion-toolbar>\n        <ion-title>Category</ion-title>\n      </ion-toolbar>\n    </ion-header>\n    <ion-content>\n      <ion-list *ngFor=\"let cat of category\">\n        <ion-item [routerLink]=\"['/', 'categories', cat.id]\">{{cat.name}}</ion-item>\n      </ion-list>\n    </ion-content>\n  </ion-menu>\n  <ion-router-outlet main></ion-router-outlet>\n</ion-split-pane>"
...
/* harmony import */ var _wpservice_service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./wpservice.service */ "./src/app/wpservice.service.ts");
...
var AppComponent = /** @class */ (function () {
    function AppComponent(badge, platform, splashScreen, statusBar, wp, oneSignal, router) {
        var _this = this;
        this.badge = badge;
        ...
        this.router = router;
        this.initializeApp();
        this.wp.getCategory().subscribe(function (data) {
            _this.category = data;
            console.log(data);
        });
    }
    ...
    AppComponent.prototype.SetupPush = function () {
        ...
        this.oneSignal.handleNotificationOpened().subscribe(function (data) {
            _this.router.navigate(['/', 'single', data.notification.payload.additionalData.postid]);
        });
    ...
    AppComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_native_badge_ngx__WEBPACK_IMPORTED_MODULE_8__["Badge"],
            _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"],
            _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"],
            _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"],
            _wpservice_service__WEBPACK_IMPORTED_MODULE_5__["WpserviceService"],
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _ionic_native_onesignal_ngx__WEBPACK_IMPORTED_MODULE_10__["OneSignal"], _ionic_native_badge_ngx__WEBPACK_IMPORTED_MODULE_11__["Badge"]
            ],
...
/***/ "./src/app/wpservice.service.ts":
/*!**************************************!*\
  !*** ./src/app/wpservice.service.ts ***!
  \**************************************/
/*! exports provided: WpserviceService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "WpserviceService", function() { return WpserviceService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var WpserviceService = /** @class */ (function () {
    function WpserviceService(http) {
        this.http = http;
        this.postslink = "https://trainingapp.gremza.com/wp-json/wp/v2/posts";
        this.categorylink = "https://trainingapp.gremza.com/wp-json/wp/v2/categories";
        this.postslinkwithpagination = "https://trainingapp.gremza.com/wp-json/wp/v2/posts?_embeded&per_page=2&page=";
    }
    WpserviceService.prototype.getPosts = function () {
        return this.http.get(this.postslink);
    };
    WpserviceService.prototype.getCategory = function () {
        return this.http.get(this.categorylink);
    };
    WpserviceService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
module.exports = __webpack_require__(/*! /Users/Marsel/Desktop/trainingapp/trainingapp/src/main.ts */"./src/main.ts");
